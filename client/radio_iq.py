...
class radio_iq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "radio_iq")
        ...
        self._values_freq_range = qtgui.Range(-samp_rate//2, samp_rate//2, 1, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, values_freq, 1, 0, 0)
    ...
    def set_values_freq(self, values_freq):
        ...
        self.analog_sig_source_x_0.set_frequency(self.values_freq)
...
def main(top_block_cls=radio_iq, options=None):
